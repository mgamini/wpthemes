	...
	<?php foreach($use_form as $form_item) : ?>
        <li>
                ...
                <div class="form-wrap">                 	
                    <?php if(is_array($form_item["sub_elements"])) :
							foreach($form_item["sub_elements"] as $sub_input) : ?>
                             <?php if($sub_input["show_if"] && get_option($sub_input["show_if"]["id"]) !== $sub_input["show_if"]["value"]) : $class="no_display"; else : $class=""; endif; ?>
            ...
            <?php else : ?>
                ...
                <div class="form-wrap">
                    <?php create_form($form_item, count($form_item), $label_class); ?>
