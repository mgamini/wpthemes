...
jQuery(document).ready(function()
	{
		...
		jQuery("[id$='_reset']").click(function(){
			rel = jQuery(this).attr("rel");
			jQuery("[id$='"+rel+"']").each(function(){
				thedefault = "#"+jQuery(this).attr("id").replace(rel, "_default");
				pickerid = "#"+jQuery(this).attr("id")+"_picker";
				if(jQuery(pickerid)){
					jQuery(pickerid+" div").css("backgroundColor" , jQuery(thedefault).val());
				}
				jQuery(this).val(jQuery(thedefault).val());
			});
