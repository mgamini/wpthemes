...
<!-- 	<?php $tags = get_tags();
$html = '<ul class="tags"><li><h6 class="tags-title">Tags:</h6></li>';
foreach ( $tags as $tag ) {
...
?> -->
	...
	query_posts('showposts='. ( 7 - $sticky ));
	...
	<?php endif; ?>
		...
		<a href="<?php echo $link ?>" rel="bookmark" title="<?php echo $title ?>" class="readmore-link">Read More ></a>
	</article>

	<?php else : ?>
	<article class="grid-item <?php if ( 0 == ($count-1)%3 ) {
        echo 'third';
    } ?>">
...
<!-- 			<a href="<?php comments_link(); ?> ">
	...
	<div id="navbelow">
		<div class="nav-prev"><a class="all-stories-link" href="/all">View All Stories ></a></div>
